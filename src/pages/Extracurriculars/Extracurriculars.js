          ...
          <div className="container">
            <div className="leftabout">
              ...
              <span className="textext">
                ...
                also provided awareness of resources to promote healthy aging
                and facilitated social engagement among older adults
              </span>
              <nav className="bottomport">
                <ul className="moreul2">
                  <li className="morelist">
          ...
          <div className="container">
            <div className="leftabout">
              ...
              <span className="textext">
                ...
                small projects using python such as blackjack, hangman,
                text-based games, etc.
                <br />
                <br />
                <b className="boldext">
                ...
                <br />
                <b className="boldext">
                  //Academic Tutor | Aug 2018 - May 2021
                </b>
                <br />
                As an academic tutor, I've supported students struggling in
                calculus 1, digital electronics, and computer science by
                preparing practice tests that simulated the actual testing
                environment and providing useful tips and strategies on how to
                approach studying.
              </span>
              <nav className="bottomport">
                <ul className="moreul2">
          ...
          <div className="container">
            ...
            <div className="right2about">
              ...
              <span className="textext">
                ...
                <br />
                As a volunteer, I've helped to sort, process, and pack food
                every summer for the underserved populations of Galveston
                County.
              </span>
              <nav className="bottomport">
                <ul className="moreul2">
          ...
          <div className="container">
            <div className="leftabout">
              ...
              <span className="textext">
                ...
                <br />
                As a volunteer, I've helped organize shelves and assisted
                patrons
              </span>
              <nav className="bottomport">
                <ul className="moreul2">
          ...
          <div className="container">
            ...
            <div className="right2about">
              ...
              <span className="textext">
                ...
                <br />
                As a volunteer, I've assisted instructors in teaching students
                to learn and read Arabic. Additionally I completed my
                memorization of the Quran at this school.
              </span>
              <nav className="bottomport">
                <ul className="moreul2">
                  <li className="morelist">
